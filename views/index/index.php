...
<div class="d-container-fluid">
  <div class="d-banner-wrapper">
    <div id="banner-fade">
      ...
      <ul class="bjqs">
        <li><div style="background-image:url('<?php echo URL; ?>public/images/image-home-1.jpg')"></div></li>
        <li><div style="background-image:url('<?php echo URL; ?>public/images/image-home-2.jpg')"></div></li>
        <li><div style="background-image:url('<?php echo URL; ?>public/images/image-home-3.jpg')"></div></li>
      </ul>
    ...
    <div class="d-banner-centered">
      <div class="d-banner-content">
        ...
        <div class="d-banner-search-wrapper">
          ...
          <div>
            <form id="search-form" action="<?php echo URL; ?>search/search" method="get">
  ...
  <div class="d-container">
    <div class="d-listing-news-container">
      ...
      <div class="main-content">
        <div class="content-1" style="background-image:url('<?php echo URL; ?>public/images/house1.jpg');">
          <div class="content-wrapper">
            <div class="address">50 Tạ Uyên</div>
            <div class="price">$2,880,000</div>
          </div>
        </div>
        <div class="content-2" style="background-image:url('<?php echo URL; ?>public/images/house2.jpg');">
          <div class="content-wrapper">
            <div class="address">300 Lý Thường Kiệt</div>
            <div class="price">$2,880,000</div>
          </div>
        </div>
        <div class="content-3" style="background-image:url('<?php echo URL; ?>public/images/house3.jpg');">
          <div class="content-wrapper">
...
<!-- contact us -->
<div class="d-container-fluid" style="background-image:url('<?php echo URL; ?>public/images/contact-us.jpg');background-size: cover; background-attachment: fixed; background-position-y:center;">
